...
const ShopContextProvider = (props) => {
  ...
  useEffect(() => {
    fetch('https://cake-factory-backend.onrender.com/api/products')
  ...
  const getTotalCartAmount = () => {
    return all_products.reduce((totalAmount, product) => {
      if (cartItems[product.id] > 0) {
        return totalAmount + product.new_price * cartItems[product.id];
      }
      return totalAmount;
    }, 0);
  };
